    ...
    function plusInfos(origine, data) {
        ...
        win = Ext.create('Ext.window.Window',{
            ...
            items: [{
                ...
                items: [{
                    title: 'Description',
                    html: '<iframe width="717" height="595" src="./metadata/'+link+'.pdf"></iframe>'
                }, {
                    title: 'Inspire',
                    html: '<iframe width="717" height="595" src="'+serverUrlGeosource+'?uuid=IGNF_BDCARTOr_3-1_'+link1+'.xml"></iframe>'
                }]
            }]
        });
